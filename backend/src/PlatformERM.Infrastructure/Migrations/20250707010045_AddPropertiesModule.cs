        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SquareFootage = table.Column<decimal>(type: "numeric", nullable: true),
                    AcreageSize = table.Column<decimal>(type: "numeric", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "text", nullable: true),
                    PropertyId = table.Column<int>(type: "integer", nullable: false),
                    AssignedToContactId = table.Column<int>(type: "integer", nullable: true),
                    TenantId = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkOrders_Contacts_AssignedToContactId",
                        column: x => x.AssignedToContactId,
                        principalTable: "Contacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyContacts_PropertyId_ContactId_Role",
                table: "PropertyContacts",
                columns: new[] { "PropertyId", "ContactId", "Role" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PropertyContacts_TenantId",
                table: "PropertyContacts",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_AssignedToContactId",
                table: "WorkOrders",
