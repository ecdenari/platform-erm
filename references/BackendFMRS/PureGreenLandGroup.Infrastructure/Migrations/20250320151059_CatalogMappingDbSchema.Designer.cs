...
namespace PureGreenLandGroup.Infrastructure.Migrations
{
    ...
    [Migration("20250320151059_CatalogMappingDbSchema")]
    partial class CatalogMappingDbSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PureGreenLandGroup.Domain.Entities.InspectionEntities.CatalogMappingLabel", b =>
                {
                    ...
                    b.Property<int>("InspectionLabelId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PureGreenLandGroup.Domain.Entities.MasterDataEntities.MstInspectionLabel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MstInspectionLabel");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            LabelName = "Valve Issue"
                        },
                        new
                        {
                            Id = 2,
                            LabelName = "Decoder Issue"
                        },
                        new
                        {
                            Id = 3,
                            LabelName = "Solenoid Issue"
                        },
                        new
                        {
                            Id = 4,
                            LabelName = "Mpr Nozzle"
                        },
                        new
                        {
                            Id = 5,
                            LabelName = "VAN Nozzle"
                        },
                        new
                        {
                            Id = 6,
                            LabelName = "Broken Spray"
                        },
                        new
                        {
                            Id = 7,
                            LabelName = "Broken Rotor"
                        },
                        new
                        {
                            Id = 8,
                            LabelName = "Raise/Lower"
                        },
                        new
                        {
                            Id = 9,
                            LabelName = "Broken Lateral"
                        },
                        new
                        {
                            Id = 10,
                            LabelName = "Broken Main"
                        });
                });
            ...
            modelBuilder.Entity("PureGreenLandGroup.Domain.Entities.InspectionEntities.CatalogMappingLabel", b =>
                {
                    b.HasOne("PureGreenLandGroup.Domain.Entities.MasterDataEntities.MstInspectionLabel", "MstInspectionLabel")
                        .WithMany()
                        .HasForeignKey("InspectionLabelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MstInspectionLabel");
                });
