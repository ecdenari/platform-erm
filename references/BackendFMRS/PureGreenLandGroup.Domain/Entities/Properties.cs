...
namespace PureGreenLandGroup.Domain.Entities
{
    public class Properties
    {
        ...
        // Template assignment for site reports
        public int? DefaultSiteReportTemplateId { get; set; }
        
        // Navigation properties
        [ForeignKey("DefaultSiteReportTemplateId")]
        public virtual SiteReportTemplate? DefaultSiteReportTemplate { get; set; }
    }
}